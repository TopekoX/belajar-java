...
//        Data<Manager> managerData = new Data<>(new Manager()); // error karna manager tidak implements CanSayHello
    ...
    // multiple constraint hanya boleh pya Objek parent class selainnya harus interface
